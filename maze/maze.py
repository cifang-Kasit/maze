...
class maze(Env):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        self.reach = np.zeros((self.nrow * self.ncol))
        nA = 4
        nS = nrow * ncol
...
#########################################################################################
    ...
    def step(self, a):
      #############################################
        ...
        if np.count_nonzero(self.reach == 1) == np.count_nonzero(self.desc == b'F')+np.count_nonzero(self.desc == b'S'):
            return (int(s), r, t, True, {"prob": p})
      ###############################################
